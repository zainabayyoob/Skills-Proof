// Target Career Tracks & Required Skills Battery
export const roleTracks = [
  {
    ...
    description: "Build robust frontend user interfaces, backend API microservices, and database models with end-to-end resilience.",
    requiredSkills: [
      { id: "htmlcss", name: "HTML / CSS", minScore: 75, icon: "Layout" },
      { id: "javascript", name: "JavaScript", minScore: 80, icon: "FileCode" },
      { id: "frontend", name: "Frontend", minScore: 78, icon: "Layers" },
      { id: "backend", name: "Backend", minScore: 80, icon: "Server" },
      { id: "sql", name: "SQL", minScore: 75, icon: "Database" }
    ]
  },
  {
    id: "backend-eng",
    ...
    description: "Design high-throughput APIs, transaction reconciliation systems, and resilient database queries.",
    requiredSkills: [
      { id: "java", name: "Java", minScore: 80, icon: "Coffee" },
      { id: "python", name: "Python", minScore: 80, icon: "FileCode2" },
      { id: "sql", name: "SQL", minScore: 80, icon: "Database" },
      { id: "backend", name: "Backend", minScore: 82, icon: "Server" }
    ]
  },
  {
    id: "frontend-eng",
    ...
    description: "Construct responsive web applications with defensive state synchronization, accessibility, and zero UI regressions.",
    requiredSkills: [
      { id: "htmlcss", name: "HTML / CSS", minScore: 80, icon: "Layout" },
      { id: "javascript", name: "JavaScript", minScore: 82, icon: "FileCode" },
      { id: "frontend", name: "Frontend", minScore: 80, icon: "Layers" }
    ]
  },
  {
    id: "data-analyst",
    ...
    description: "Quarantine contaminated data batches, calculate KPI metrics, isolate churn anomalies, and formulate analytical queries.",
    requiredSkills: [
      { id: "dataanalytics", name: "Data Analytics", minScore: 80, icon: "BarChart2" },
      { id: "sql", name: "SQL", minScore: 80, icon: "Database" },
      { id: "python", name: "Python", minScore: 78, icon: "FileCode2" }
    ]
  },
  {
    id: "systems-eng",
    ...
    description: "Develop low-level memory-safe algorithms, prevent buffer overflows, and engineer STL telemetry engines.",
    requiredSkills: [
      { id: "c", name: "C", minScore: 82, icon: "Cpu" },
      { id: "cpp", name: "C++", minScore: 82, icon: "Code2" },
      { id: "sql", name: "SQL", minScore: 75, icon: "Database" }
    ]
  },
  {
    ...
    description: "Engineer enterprise Spring/Java pipelines handling high-concurrency order streams without NullPointerExceptions.",
    requiredSkills: [
      { id: "java", name: "Java", minScore: 82, icon: "Coffee" },
      { id: "sql", name: "SQL", minScore: 78, icon: "Database" },
      { id: "backend", name: "Backend", minScore: 78, icon: "Server" }
    ]
  }
];
